...
namespace Gridiron.Engine.Tests
{
    ...
    public class ActionTests
    {
        ...
        public void GameAdvancesQuartersAndHalvesCorrectlyTest()
        {
            ...
            var endOfHalfRules = EndOfHalfRulesRegistry.Default;
            var quarterExpireCheck = new QuarterExpireCheck(twoMinuteWarningRules);
            var halfExpireCheck = new HalfExpireCheck(endOfHalfRules);
            ...
            Assert.AreEqual(Gridiron.Engine.Domain.Time.QuarterType.Second, game.CurrentQuarter.QuarterType);
            Assert.AreEqual(HalfType.First, game.CurrentHalf.HalfType);
            ...
            Assert.AreEqual(Gridiron.Engine.Domain.Time.QuarterType.Third, game.CurrentQuarter.QuarterType);
            ...
            Assert.AreEqual(Gridiron.Engine.Domain.Time.QuarterType.Fourth, game.CurrentQuarter.QuarterType);
            Assert.AreEqual(HalfType.Second, game.CurrentHalf.HalfType);
            Assert.IsTrue(game.CurrentPlay.QuarterExpired);
            Assert.IsFalse(game.CurrentPlay.HalfExpired);
            ...
            Assert.AreEqual(Gridiron.Engine.Domain.Time.QuarterType.GameOver, game.CurrentQuarter.QuarterType);
